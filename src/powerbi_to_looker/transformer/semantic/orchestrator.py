"""Transformer orchestrator: metadata_model -> SemanticLayerArtifact (views, explores, conversion_summary)."""
...
from powerbi_to_looker.transformer.semantic.explore_builder import build_explores
from powerbi_to_looker.transformer.semantic.view_builder import build_views
...
def run(metadata_model: dict[str, Any] | Path) -> SemanticLayerArtifact:
    ...
    _rw_path = Path(__file__).resolve().parent.parent.parent / "config" / "looker_reserved_words.yaml"
